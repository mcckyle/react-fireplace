...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ia(e,t,n){let r=new Float32Array(Sa),i=new W(0,1,0);return new yi({name:`SphericalGaussianBlur`,defines:{n:Sa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:za(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function La(){return new yi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:za(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ra(){return new yi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:za(),fragmentShader:`
	...
	`}var Ba=class extends Ut{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ai(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var ds={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function fs(e,t){let n=ds[t];return n===void 0?(z(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var ps=new W;function ms(){return K.getLuminanceCoefficients(ps),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${ps.x.toFixed(4)}, ${ps.y.toFixed(4)}, ${ps.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            `}),s=new qr(new ui(2,2),o);n.add(s);let c,l=()=>{a.uTime.value+=.016,a.uHeat.value=parseFloat(getComputedStyle(document.documentElement).getPropertyValue(`--fire-energy`))||1,i.render(n,r),c=requestAnimationFrame(l)};l();let u=()=>{let e=t.clientWidth,n=t.clientHeight;i.setSize(e,n),a.uResolution.value.set(e,n)};return window.addEventListener(`resize`,u),()=>{cancelAnimationFrame(c),window.removeEventListener(`resize`,u),s.geometry.dispose(),o.dispose(),i.dispose(),i.domElement.parentNode&&i.domElement.parentNode.removeChild(i.domElement)}},[]),(0,f.jsx)(`div`,{ref:e,className:`heat-webgl`,"aria-hidden":!0})}function Ec(){let e=(0,l.useRef)(null),t=(0,l.useRef)(null),n=(0,l.useRef)(null);(0,l.useRef)(null);let[r,i]=(0,l.useState)(!1);return(0,l.useEffect)(()=>{let t=e.current;if(!t)return;let n=1,r=1,i=0,a=.8,o=1,s=performance.now(),c=null,l=()=>{r=Math.random()<.08?1.12+Math.random()*.14:.91+Math.random()*.12},u=e=>{if(document.hidden){c=null;return}e>=s&&(l(),s=e+1600+Math.random()*3600);let d=Math.sin(e*.0024),f=Math.sin(e*.0105+2.15),p=Math.sin(e*.041+5.4)*.55+Math.sin(e*.083+2.7)*.45;i+=(r-n)*.017,i*=.935,n+=i,o=.985+d*.018+f*.022+p*.012;let m=.72+n*.012;a+=(m-a)*.014,t.style.setProperty(`--intensity`,n.toFixed(3)),t.style.setProperty(`--heat`,a.toFixed(3)),t.style.setProperty(`--flicker`,o.toFixed(3)),c=requestAnimationFrame(u)},d=()=>{c===null&&(c=requestAnimationFrame(u))};return l(),c=requestAnimationFrame(u),document.addEventListener(`visibilitychange`,d),()=>{c!==null&&cancelAnimationFrame(c),document.removeEventListener(`visibilitychange`,d)}},[]),(0,l.useEffect)(()=>{let e=t.current;if(!e)return;n.current!==null&&cancelAnimationFrame(n.current);let a=r?.34:0;r&&e.paused&&(e.volume=Math.min(e.volume,a),e.play().catch(()=>{i(!1)}));let o=()=>{let t=e.volume,r=a-t;if(Math.abs(r)<.004){e.volume=a,a===0&&(e.pause(),e.currentTime=0),n.current=null;return}e.volume=t+r*.08,n.current=requestAnimationFrame(o)};return n.current=requestAnimationFrame(o),()=>{n.current!==null&&cancelAnimationFrame(n.current)}},[r]),(0,f.jsxs)(`main`,{ref:e,className:`room`,"aria-label":`Digital fireplace`,children:[(0,f.jsx)(`audio`,{ref:t,src:`/react-fireplace/audio/fireplace-crackle.mp3`,loop:!0,preload:`auto`,"aria-hidden":`true`}),(0,f.jsx)(`div`,{className:`room-ambient-light`,"aria-hidden":`true`}),(0,f.jsx)(`div`,{className:`room-firelight-projection`,"aria-hidden":`true`}),(0,f.jsx)(`div`,{className:`room-vignette`,"aria-hidden":`true`}),(0,f.jsx)(`button`,{type:`button`,className:`sound-toggle`,onClick:()=>i(e=>!e),"aria-label":r?`Disable fireplace sound`:`Enable fireplace sound`,"aria-pressed":r,children:(0,f.jsx)(`svg`,{className:`sound-icon`,viewBox:`0 0 24 24`,"aria-hidden":`true`,children:r?(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(`path`,{d:`M4 9v6h4l5 4V5L8 9H4Z`,fill:`currentColor`}),(0,f.jsx)(`path`,{d:`M16 9.5c1.1 1.1 1.1 3.9 0 5`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.7`,strokeLinecap:`round`}),(0,f.jsx)(`path`,{d:`M18.5 7c2.4 2.5 2.4 7.5 0 10`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.5`,strokeLinecap:`round`})]}):(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(`path`,{d:`M4 9v6h4l5 4V5L8 9H4Z`,fill:`currentColor`}),(0,f.jsx)(`path`,{d:`m17 9-5 6`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.7`,strokeLinecap:`round`}),(0,f.jsx)(`path`,{d:`m12 9 5 6`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.7`,strokeLinecap:`round`})]})})}),(0,f.jsxs)(`section`,{className:`fireplace-shell`,children:[(0,f.jsx)(`div`,{className:`mantle`,"aria-hidden":`true`}),(0,f.jsxs)(`div`,{className:`firebox`,children:[(0,f.jsx)(`div`,{className:`firebox-reflection`,"aria-hidden":`true`}),(0,f.jsx)(Tc,{}),(0,f.jsx)(`div`,{className:`glow`,"aria-hidden":`true`}),(0,f.jsx)(h,{}),(0,f.jsx)(`div`,{className:`coal-bed`,"aria-hidden":`true`}),(0,f.jsx)(`div`,{className:`logs`,"aria-hidden":`true`}),(0,f.jsx)(p,{count:4,intensity:.84,blur:12,zIndex:1}),(0,f.jsx)(p,{count:9,intensity:1,blur:5,zIndex:2,phase:-1.2}),(0,f.jsx)(p,{count:14,intensity:1.08,blur:0,zIndex:3,phase:-2.4})]}),(0,f.jsx)(`div`,{className:`hearth`,"aria-hidden":`true`})]})]})}function Dc(){return(0,f.jsx)(Ec,{})}(0,u.createRoot)(document.getElementById(`root`)).render((0,f.jsx)(l.StrictMode,{children:(0,f.jsx)(Dc,{})}));