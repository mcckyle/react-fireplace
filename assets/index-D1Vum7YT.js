...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=os(i,i.VERTEX_SHADER,y),S=os(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=fs(i,x,`vertex`),n=fs(i,S,`fragment`);V(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            `}),s=new Jr(new di(2,2),o);n.add(s);let c,l=()=>{a.uTime.value+=.016,a.uHeat.value=parseFloat(getComputedStyle(document.documentElement).getPropertyValue(`--fire-energy`))||1,i.render(n,r),c=requestAnimationFrame(l)};l();let u=()=>{let e=t.clientWidth,n=t.clientHeight;i.setSize(e,n),a.uResolution.value.set(e,n)};return window.addEventListener(`resize`,u),()=>{cancelAnimationFrame(c),window.removeEventListener(`resize`,u),s.geometry.dispose(),o.dispose(),i.dispose(),i.domElement.parentNode&&i.domElement.parentNode.removeChild(i.domElement)}},[]),(0,f.jsx)(`div`,{ref:e,className:`heat-webgl`,"aria-hidden":!0})}function kc(){let e=(0,l.useRef)(null),t=(0,l.useRef)(null);(0,l.useRef)(null);let[n,r]=(0,l.useState)(!1);return(0,l.useEffect)(()=>{let e,t=1,n=1,r=0,i=.8,a=1,o=()=>{n=Math.random()<.1?1.15+Math.random()*.12:.9+Math.random()*.15};o();let s=performance.now(),c=l=>{if(!document.hidden){l>s&&(o(),s=l+1800+Math.random()*3500),r+=(n-t)*.018,r*=.94,t+=r,a=.94+Math.sin(l*.018)*.035+Math.random()*.025,i+=(t*.82-i)*.015;let e=document.documentElement;e.style.setProperty(`--intensity`,t.toFixed(3)),e.style.setProperty(`--heat`,i.toFixed(3)),e.style.setProperty(`--flicker`,a.toFixed(3))}e=requestAnimationFrame(c)};return e=requestAnimationFrame(c),()=>cancelAnimationFrame(e)},[]),(0,l.useEffect)(()=>{let r=e.current;if(!r)return;cancelAnimationFrame(t.current);let i=n?.34:0;n&&r.paused&&r.play().catch(()=>{});let a=()=>{let e=i-r.volume;if(Math.abs(e)<.005){r.volume=i,i===0&&r.pause();return}r.volume+=e*.05,t.current=requestAnimationFrame(a)};return a(),()=>cancelAnimationFrame(t.current)},[n]),(0,f.jsxs)(`main`,{className:`room`,"aria-label":`Digital fireplace`,children:[(0,f.jsx)(`audio`,{ref:e,src:`/react-fireplace/audio/fireplace-crackle.mp3`,loop:!0,preload:`auto`}),(0,f.jsx)(`div`,{className:`room-vignette`}),(0,f.jsx)(`div`,{className:`room-ambient-light`}),(0,f.jsx)(`div`,{className:`room-firelight-projection`}),(0,f.jsx)(`button`,{type:`button`,className:`sound-toggle`,onClick:()=>r(e=>!e),"aria-label":n?`Disable fireplace sound`:`Enable fireplace sound`,children:n?`🔊`:`🔇`}),(0,f.jsxs)(`section`,{className:`fireplace-shell`,children:[(0,f.jsx)(`div`,{className:`mantle`}),(0,f.jsxs)(`div`,{className:`firebox`,children:[(0,f.jsx)(`div`,{className:`firebox-reflection`}),(0,f.jsx)(Oc,{}),(0,f.jsx)(`div`,{className:`glow`}),(0,f.jsx)(h,{}),(0,f.jsx)(`div`,{className:`coal-bed`}),(0,f.jsx)(`div`,{className:`logs`}),(0,f.jsx)(p,{count:4,intensity:.84,blur:12,zIndex:1}),(0,f.jsx)(p,{count:9,intensity:1,blur:5,zIndex:2,phase:-1.2}),(0,f.jsx)(p,{count:14,intensity:1.08,blur:0,zIndex:3,phase:-2.4})]}),(0,f.jsx)(`div`,{className:`hearth`})]})]})}function Ac(){return(0,f.jsx)(kc,{})}(0,u.createRoot)(document.getElementById(`root`)).render((0,f.jsx)(l.StrictMode,{children:(0,f.jsx)(Ac,{})}));