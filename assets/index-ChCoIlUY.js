...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function La(e,t,n){let r=new Float32Array(Ca),i=new W(0,1,0);return new vi({name:`SphericalGaussianBlur`,defines:{n:Ca,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ba(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ra(){return new vi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ba(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function za(){return new vi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ba(),fragmentShader:`
	...
	`}var Va=class extends Ut{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new ai([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var fs={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function ps(e,t){let n=fs[t];return n===void 0?(z(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var ms=new W;function hs(){return K.getLuminanceCoefficients(ms),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${ms.x.toFixed(4)}, ${ms.y.toFixed(4)}, ${ms.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            `}),s=new qr(new ui(2,2),o);n.add(s);let c,l=()=>{a.uTime.value+=.016,i.render(n,r),c=requestAnimationFrame(l)};l();let u=()=>{let e=t.clientWidth,n=t.clientHeight;i.setSize(e,n),a.uResolution.value.set(e,n)};return window.addEventListener(`resize`,u),()=>{cancelAnimationFrame(c),window.removeEventListener(`resize`,u),i.dispose(),t.removeChild(i.domElement)}},[]),(0,d.jsx)(`div`,{ref:e,className:`heat-webgl`,"aria-hidden":!0})}function Ec(){let e=(0,l.useRef)(null),t=(0,l.useRef)(null),[n,r]=(0,l.useState)(!1),[i,a]=(0,l.useState)(1);return(0,l.useEffect)(()=>{let e=1,n=1,r=0,i=performance.now(),o=()=>{n=.9+Math.random()*.25,i=performance.now()};o();let s=c=>{c-i>26e3&&o();let l=(n-e)*.02;r=r*.88+l,e+=r,a(e),t.current=requestAnimationFrame(s)};return t.current=requestAnimationFrame(s),()=>{cancelAnimationFrame(t.current)}},[]),(0,l.useEffect)(()=>{document.documentElement.style.setProperty(`--intensity`,i.toFixed(3))},[i]),(0,l.useEffect)(()=>{let t=e.current;if(!t)return;let r;return n?(t.volume=0,t.play().catch(()=>{}),r=setInterval(()=>{t.volume=Math.min(t.volume+.015,.32),t.volume>=.32&&clearInterval(r)},50)):r=setInterval(()=>{t.volume=Math.max(t.volume-.02,0),t.volume===0&&(t.pause(),clearInterval(r))},50),()=>clearInterval(r)},[n]),(0,d.jsxs)(`div`,{className:`room`,children:[(0,d.jsx)(`audio`,{ref:e,src:`/react-fireplace/audio/fireplace-crackle.mp3`,loop:!0,preload:`auto`}),(0,d.jsx)(`button`,{className:`sound-toggle`,onClick:()=>r(e=>!e),"aria-label":`Toggle fireplace sound`,children:n?`🔊`:`🔇`}),(0,d.jsxs)(`div`,{className:`fireplace-shell`,children:[(0,d.jsx)(`div`,{className:`mantle`}),(0,d.jsxs)(`div`,{className:`firebox`,children:[(0,d.jsx)(Tc,{}),(0,d.jsx)(`div`,{className:`glow`}),(0,d.jsx)(m,{}),(0,d.jsx)(`div`,{className:`logs`}),(0,d.jsx)(f,{count:4,intensity:i*.85,blur:10,zIndex:1}),(0,d.jsx)(f,{count:9,intensity:i,blur:5,zIndex:2,phase:-1.2}),(0,d.jsx)(f,{count:14,intensity:i*1.1,blur:0,zIndex:3,phase:-2.4})]}),(0,d.jsx)(`div`,{className:`hearth`})]})]})}function Dc(){return(0,d.jsx)(`main`,{className:`app`,"aria-label":`Fireplace experience`,children:(0,d.jsx)(Ec,{})})}(0,c.createRoot)(document.getElementById(`root`)).render((0,d.jsx)(l.StrictMode,{children:(0,d.jsx)(Dc,{})}));