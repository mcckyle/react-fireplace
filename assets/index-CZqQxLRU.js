...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            `}),s=new qr(new ui(2,2),o);n.add(s);let c,l=()=>{a.uTime.value+=.016,a.uHeat.value=parseFloat(getComputedStyle(document.documentElement).getPropertyValue(`--fire-energy`))||1,i.render(n,r),c=requestAnimationFrame(l)};l();let u=()=>{let e=t.clientWidth,n=t.clientHeight;i.setSize(e,n),a.uResolution.value.set(e,n)};return window.addEventListener(`resize`,u),()=>{cancelAnimationFrame(c),window.removeEventListener(`resize`,u),s.geometry.dispose(),o.dispose(),i.dispose(),i.domElement.parentNode&&i.domElement.parentNode.removeChild(i.domElement)}},[]),(0,f.jsx)(`div`,{ref:e,className:`heat-webgl`,"aria-hidden":!0})}function Ec(){let e=(0,l.useRef)(null),t=(0,l.useRef)(null),n=(0,l.useRef)(null),r=(0,l.useRef)(null),[i,a]=(0,l.useState)(!1);return(0,l.useEffect)(()=>{let t=1,n=1,i=0,a=.8,o=1,s=()=>{n=Math.random()<.1?1.15+Math.random()*.12:.9+Math.random()*.15};s();let c=performance.now(),l=u=>{if(!document.hidden){u>c&&(s(),c=u+1800+Math.random()*3500);let r=Math.sin(u*.0027),l=Math.sin(u*.011+2.1),d=Math.sin(u*.047+5.7)*.55+Math.sin(u*.091+2.8)*.45;i+=(n-t)*.018,i*=.94,t+=i,o=.98+r*.02+l*.025+d*.015,a+=(t*.82-a)*.015;let f=e.current;f&&(f.style.setProperty(`--intensity`,t.toFixed(3)),f.style.setProperty(`--heat`,a.toFixed(3)),f.style.setProperty(`--flicker`,o.toFixed(3)))}r.current=requestAnimationFrame(l)};return r.current=requestAnimationFrame(l),()=>cancelAnimationFrame(r.current)},[]),(0,l.useEffect)(()=>{let e=t.current;if(!e)return;cancelAnimationFrame(n.current);let r=i?.34:0;i&&e.paused&&e.play().catch(()=>{});let a=()=>{let t=r-e.volume;if(Math.abs(t)<.005){e.volume=r,r===0&&e.pause();return}e.volume+=t*.05,n.current=requestAnimationFrame(a)};return a(),()=>cancelAnimationFrame(n.current)},[i]),(0,f.jsxs)(`main`,{ref:e,className:`room`,"aria-label":`Digital fireplace`,children:[(0,f.jsx)(`audio`,{ref:t,src:`/react-fireplace/audio/fireplace-crackle.mp3`,loop:!0,preload:`auto`}),(0,f.jsx)(`div`,{className:`room-vignette`}),(0,f.jsx)(`div`,{className:`room-ambient-light`}),(0,f.jsx)(`div`,{className:`room-firelight-projection`}),(0,f.jsx)(`button`,{type:`button`,className:`sound-toggle`,onClick:()=>a(e=>!e),"aria-label":i?`Disable fireplace sound`:`Enable fireplace sound`,children:i?`🔊`:`🔇`}),(0,f.jsxs)(`section`,{className:`fireplace-shell`,children:[(0,f.jsx)(`div`,{className:`mantle`}),(0,f.jsxs)(`div`,{className:`firebox`,children:[(0,f.jsx)(`div`,{className:`firebox-reflection`}),(0,f.jsx)(Tc,{}),(0,f.jsx)(`div`,{className:`glow`}),(0,f.jsx)(h,{}),(0,f.jsx)(`div`,{className:`coal-bed`}),(0,f.jsx)(`div`,{className:`logs`}),(0,f.jsx)(p,{count:4,intensity:.84,blur:12,zIndex:1}),(0,f.jsx)(p,{count:9,intensity:1,blur:5,zIndex:2,phase:-1.2}),(0,f.jsx)(p,{count:14,intensity:1.08,blur:0,zIndex:3,phase:-2.4})]}),(0,f.jsx)(`div`,{className:`hearth`})]})]})}function Dc(){return(0,f.jsx)(Ec,{})}(0,u.createRoot)(document.getElementById(`root`)).render((0,f.jsx)(l.StrictMode,{children:(0,f.jsx)(Dc,{})}));