...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ra(e,t,n){let r=new Float32Array(wa),i=new W(0,1,0);return new yi({name:`SphericalGaussianBlur`,defines:{n:wa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Va(),fragmentShader:`
	...
	`}var Ha=class extends Ut{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ai(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var ps={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function ms(e,t){let n=ps[t];return n===void 0?(z(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var hs=new W;function gs(){return K.getLuminanceCoefficients(hs),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${hs.x.toFixed(4)}, ${hs.y.toFixed(4)}, ${hs.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            `}),s=new qr(new ui(2,2),o);n.add(s);let c,l=()=>{a.uTime.value+=.016,a.uHeat.value=parseFloat(getComputedStyle(document.documentElement).getPropertyValue(`--fire-energy`))||1,i.render(n,r),c=requestAnimationFrame(l)};l();let u=()=>{let e=t.clientWidth,n=t.clientHeight;i.setSize(e,n),a.uResolution.value.set(e,n)};return window.addEventListener(`resize`,u),()=>{cancelAnimationFrame(c),window.removeEventListener(`resize`,u),s.geometry.dispose(),o.dispose(),i.dispose(),i.domElement.parentNode&&i.domElement.parentNode.removeChild(i.domElement)}},[]),(0,f.jsx)(`div`,{ref:e,className:`heat-webgl`,"aria-hidden":!0})}function Oc(){let e=(0,l.useRef)(null),t=(0,l.useRef)(null),n=(0,l.useRef)(null),r=(0,l.useRef)(null),[i,a]=(0,l.useState)(!1);return(0,l.useEffect)(()=>{let t=1,n=1,i=0,a=.8,o=1,s=()=>{n=Math.random()<.1?1.15+Math.random()*.12:.9+Math.random()*.15};s();let c=performance.now(),l=u=>{if(!document.hidden){u>c&&(s(),c=u+1800+Math.random()*3500);let r=Math.sin(u*.0027),l=Math.sin(u*.011+2.1),d=Math.random()-.5;i+=(n-t)*.018,i*=.94,t+=i,o=.97+r*.02+l*.03+d*.018,a+=(t*.82-a)*.015;let f=e.current;f&&(f.style.setProperty(`--intensity`,t.toFixed(3)),f.style.setProperty(`--heat`,a.toFixed(3)),f.style.setProperty(`--flicker`,o.toFixed(3)))}r.current=requestAnimationFrame(l)};return r.current=requestAnimationFrame(l),()=>cancelAnimationFrame(r.current)},[]),(0,l.useEffect)(()=>{let e=t.current;if(!e)return;cancelAnimationFrame(n.current);let r=i?.34:0;i&&e.paused&&e.play().catch(()=>{});let a=()=>{let t=r-e.volume;if(Math.abs(t)<.005){e.volume=r,r===0&&e.pause();return}e.volume+=t*.05,n.current=requestAnimationFrame(a)};return a(),()=>cancelAnimationFrame(n.current)},[i]),(0,f.jsxs)(`main`,{ref:e,className:`room`,"aria-label":`Digital fireplace`,children:[(0,f.jsx)(`audio`,{ref:t,src:`/react-fireplace/audio/fireplace-crackle.mp3`,loop:!0,preload:`auto`}),(0,f.jsx)(`div`,{className:`room-vignette`}),(0,f.jsx)(`div`,{className:`room-ambient-light`}),(0,f.jsx)(`div`,{className:`room-firelight-projection`}),(0,f.jsx)(`button`,{type:`button`,className:`sound-toggle`,onClick:()=>a(e=>!e),"aria-label":i?`Disable fireplace sound`:`Enable fireplace sound`,children:i?`🔊`:`🔇`}),(0,f.jsxs)(`section`,{className:`fireplace-shell`,children:[(0,f.jsx)(`div`,{className:`mantle`}),(0,f.jsxs)(`div`,{className:`firebox`,children:[(0,f.jsx)(`div`,{className:`firebox-reflection`}),(0,f.jsx)(Dc,{}),(0,f.jsx)(`div`,{className:`glow`}),(0,f.jsx)(h,{}),(0,f.jsx)(`div`,{className:`coal-bed`}),(0,f.jsx)(`div`,{className:`logs`}),(0,f.jsx)(p,{count:4,intensity:.84,blur:12,zIndex:1}),(0,f.jsx)(p,{count:9,intensity:1,blur:5,zIndex:2,phase:-1.2}),(0,f.jsx)(p,{count:14,intensity:1.08,blur:0,zIndex:3,phase:-2.4})]}),(0,f.jsx)(`div`,{className:`hearth`})]})]})}function kc(){return(0,f.jsx)(Oc,{})}(0,u.createRoot)(document.getElementById(`root`)).render((0,f.jsx)(l.StrictMode,{children:(0,f.jsx)(kc,{})}));