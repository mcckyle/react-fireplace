...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function za(e,t,n){let r=new Float32Array(Ta),i=new W(0,1,0);return new bi({name:`SphericalGaussianBlur`,defines:{n:Ta,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ha(),fragmentShader:`
	...
	`}var Ua=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new oi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            `}),s=new Jr(new di(2,2),o);n.add(s);let c,l=()=>{a.uTime.value+=.016,i.render(n,r),c=requestAnimationFrame(l)};l();let u=()=>{let e=t.clientWidth,n=t.clientHeight;i.setSize(e,n),a.uResolution.value.set(e,n)};return window.addEventListener(`resize`,u),()=>{cancelAnimationFrame(c),window.removeEventListener(`resize`,u),s.geometry.dispose(),o.dispose(),i.dispose(),i.domElement.parentNode&&i.domElement.parentNode.removeChild(i.domElement)}},[]),(0,f.jsx)(`div`,{ref:e,className:`heat-webgl`,"aria-hidden":!0})}function kc(){let e=(0,l.useRef)(null),t=(0,l.useRef)(null),n=(0,l.useRef)(null),[r,i]=(0,l.useState)(!1);return(0,l.useEffect)(()=>{let e=1,t=1,r=0,i=performance.now(),a=()=>{t=Math.random()<.12?1.12+Math.random()*.16:.92+Math.random()*.16,i=performance.now()};a();let o=s=>{if(document.hidden){n.current=requestAnimationFrame(o);return}s-i>2400+Math.random()*2400&&a();let c=(t-e)*.015;r*=.93,r+=c,e+=r,document.documentElement.style.setProperty(`--intensity`,e.toFixed(3)),n.current=requestAnimationFrame(o)};return n.current=requestAnimationFrame(o),()=>cancelAnimationFrame(n.current)},[]),(0,l.useEffect)(()=>{let n=e.current;if(!n)return;cancelAnimationFrame(t.current);let i=r?.34:0;r&&n.paused&&n.play().catch(()=>{});let a=()=>{let e=i-n.volume;if(Math.abs(e)<.005){n.volume=i,i===0&&n.pause();return}n.volume+=e*.05,t.current=requestAnimationFrame(a)};return a(),()=>cancelAnimationFrame(t.current)},[r]),(0,f.jsxs)(`main`,{className:`room`,"aria-label":`Digital fireplace`,children:[(0,f.jsx)(`audio`,{ref:e,src:`/react-fireplace/audio/fireplace-crackle.mp3`,loop:!0,preload:`auto`}),(0,f.jsx)(`div`,{className:`room-vignette`}),(0,f.jsx)(`div`,{className:`room-ambient-light`}),(0,f.jsx)(`div`,{className:`room-firelight-projection`}),(0,f.jsx)(`button`,{type:`button`,className:`sound-toggle`,onClick:()=>i(e=>!e),"aria-label":r?`Disable fireplace sound`:`Enable fireplace sound`,children:r?`🔊`:`🔇`}),(0,f.jsxs)(`section`,{className:`fireplace-shell`,children:[(0,f.jsx)(`div`,{className:`mantle`}),(0,f.jsxs)(`div`,{className:`firebox`,children:[(0,f.jsx)(`div`,{className:`firebox-reflection`}),(0,f.jsx)(Oc,{}),(0,f.jsx)(`div`,{className:`glow`}),(0,f.jsx)(h,{}),(0,f.jsx)(`div`,{className:`coal-bed`}),(0,f.jsx)(`div`,{className:`logs`}),(0,f.jsx)(p,{count:4,intensity:.84,blur:12,zIndex:1}),(0,f.jsx)(p,{count:9,intensity:1,blur:5,zIndex:2,phase:-1.2}),(0,f.jsx)(p,{count:14,intensity:1.08,blur:0,zIndex:3,phase:-2.4})]}),(0,f.jsx)(`div`,{className:`hearth`})]})]})}function Ac(){return(0,f.jsx)(kc,{})}(0,u.createRoot)(document.getElementById(`root`)).render((0,f.jsx)(l.StrictMode,{children:(0,f.jsx)(Ac,{})}));